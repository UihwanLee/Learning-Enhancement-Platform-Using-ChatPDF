...
async function preEvaluate() {
  ...
  이런 형식으로 아래 질문과 답변 5개에 대해 각각 평가를 해줘. 절대 다른 말은 하지말고 평가만 해줘.
...
async function evaluate() {
  ...
  let evalPrompt = `아래 질문과 답변들에 대해 각각 평가를 해줘. 평가는 점수, 모범답변, 종합의견 3가지로 나눠서 해주고 점수는 0~100점, 모범답변은 질문에 대해 가장 정답에 가까운 예시 답변, 종합의견은 답변에 대한 평가를 해줘. 점수, 모범답변, 종합의견 사이에는 '/' 문자를 하나 넣어주고 각각의 평가들 사이에는 '#' 문자 하나를 넣어주고, 첫번째 답변에 대한 평가 점수 앞에 '!' 문자 하나, 마지막 답변에 대한 종합의견 끝에 '!' 문자 하나를 넣어줘. 예를 들면
  !80/O(log n)/올바른 답변입니다. 정확한 시간 복잡도를 제시했습니다.#
  90/O(n^2)/올바른 답변입니다. 다만, 최악의 경우를 피하기 위한 피벗 선택 전략에 대한 추가 설명이 있으면 더 좋습니다.#
  95/큐/올바른 답변입니다. 정확한 자료 구조를 제시했습니다.#!
  이런 형식에 따라서 다음 질문과 답변들에 대해 각각 평가를 해줘. 질문이랑 답변은 말하지 말고 오직 평가만 해줘.`;
