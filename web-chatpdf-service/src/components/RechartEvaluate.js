import {
  ...
  const evaluationCounts = props.data.reduce((acc, item) => {
    ...
    const evaluationData = [
      ...
      { name: 'Bad', algorithm: evaluationCounts.Bad["알고리즘"], network: evaluationCounts.Bad["네트워크"], operating_system: evaluationCounts.Bad["운영체제"], database: evaluationCounts.Bad["데이터베이스"] },
      { name: 'Not Bad', algorithm: evaluationCounts.NotBad["알고리즘"], network: evaluationCounts.NotBad["네트워크"], operating_system: evaluationCounts.NotBad["운영체제"], database: evaluationCounts.NotBad["데이터베이스"] },
      { name: 'Good', algorithm: evaluationCounts.Good["알고리즘"], network: evaluationCounts.Good["네트워크"], operating_system: evaluationCounts.Good["운영체제"], database: evaluationCounts.Good["데이터베이스"] },
